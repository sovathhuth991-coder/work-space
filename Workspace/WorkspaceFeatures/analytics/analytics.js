...
// Now wired into switchView()'s viewInitMap in WorkspaceCore/app.js —
// renderAnalytics(), renderFocusHistory(), and renderHeatmap() all run
// every time the user navigates to Analytics, not just on page load.
